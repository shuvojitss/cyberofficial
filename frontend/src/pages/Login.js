...
const Login = ({ setUserProfile }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const API_URL = 'https://railwayback-production-d3fc.up.railway.app';
      ...
      <div className={`glass-card ${showSuccess ? 'success-glow' : ''}`}>
        ...
        <form className="login-form" onSubmit={handleSubmit}>
          ...
          <div className={`social-buttons form-element ${formFadeOut ? 'fade-out' : ''}`}>
            <button type="button" className="social-btn" onClick={() => window.location.href = 'https://railwayback-production-d3fc.up.railway.app/auth/google'}>
            ...
            <button type="button" className="social-btn" onClick={() => window.location.href = 'https://railwayback-production-d3fc.up.railway.app/auth/github'}>
